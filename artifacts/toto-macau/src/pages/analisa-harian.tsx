...
import { BarChart2, TrendingUp, TrendingDown, Flame, Zap, ChevronDown, ChevronUp } from "lucide-react";
...
function SlotCard({ analysis, defaultOpen }: { analysis: SlotAnalysis; defaultOpen: boolean }) {
  ...
  return (
    <div className={cn(
      ...
      todayVal ? "border-primary/30 bg-card" : "border-border bg-card"
    )}>
      {/* Header */}
      <button
...
export default function AnalisaHarianPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5 px-4 pb-24 pt-6 md:pb-6">
      ...
      {/* Guide */}
      <div className="rounded-xl border border-border bg-card/50 p-4 text-xs text-muted-foreground space-y-2">
