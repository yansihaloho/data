...
const NAV_ITEMS = [
  ...
  { href: "/smart-ai",    label: "Smart AI",    desc: "Ensemble 7 engine AI",               icon: Brain,    badge: "AI", badgeCls: "bg-blue-500 text-white",   iconBg: "bg-blue-500/20 text-blue-400",    statKey: null },
];
    ...
    <div className="fixed inset-0 z-[200] flex flex-col justify-end lg:hidden">
      ...
      <div className="relative animate-in slide-in-from-bottom duration-300 ease-out">
        ...
        <div className="rounded-t-3xl bg-card border-t border-border overflow-hidden">
          ...
          {/* Menu Items */}
          <div className="px-3 py-2 pb-6 space-y-0.5">
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href} onClick={onClose}>
                  <button
                    className={cn(
                      "w-full flex items-center gap-3.5 px-3 py-3 rounded-2xl transition-all duration-150 text-left",
                      isActive
